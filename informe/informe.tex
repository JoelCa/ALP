...
\item Proof: contiene las funciones que operan sobre la construccíon de la prueba.
...
\item TypeSubstitution: oculta la substitución.
...
\item LambdaTermDefinition: oculta funciones que operan sobre el lambda término con aujeros.
\item Hyphotesis: 
\end{itemize}
