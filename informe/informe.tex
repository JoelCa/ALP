...
$\langle unit_{1} \rangle$ \= $::=$ $\langle unit_{2} \rangle$ ( \texttt{'$\vee$'} $\langle unit_{1} \rangle$ | $\varepsilon$ ) \\
$\langle unit_{2} \rangle$ \= $::=$ $\langle unit_{3} \rangle$ ( \texttt{'$\wedge$'} $\langle unit_{2} \rangle$ | $\varepsilon$ ) \\
$\langle unit_{3} \rangle$ \= $::=$ \texttt{'('} $\langle typeterm \rangle$ \texttt{')'} | \texttt{'\textasciitilde'} $\langle unit_{3} \rangle$ | 
$\langle var \rangle$ | $\langle const \rangle$ | $\langle unaryOps \rangle$
\end{tabbing}

Consideramos a $\langle const \rangle$ y $\langle unaryOps \rangle$, como las gramáticas de los operadores vacíos y unarios, respectivamente,
