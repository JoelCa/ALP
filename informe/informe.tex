...
El asistente de prueba, implementa el isomorfismo Curry-Howard, con lo cual se construye un lambda término
...
Para probarlo aplicaremos las reglas de eliminación e introducción mediante el uso de las tácticas.

En la Cuadro \ref{Ejemplo}, vemos la prueba realizada, donde la aplicación de cada táctica corresponde a un lambda término.
Una vez finalizada la prueba, se tiene un lambda término completo.

En el Cuadro \ref{Ejemplo} la columna \textbf{Tácticas} indica las tácticas ingresadas por el usuario. 
La columna \textbf{Lambda término} muestra el lambda término asociado a la prueba, 
y por último \textbf{Derivación} tiene la derivación que resta probar una vez procesadas las tácticas.
