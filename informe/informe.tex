...
La implementación del Sistema F sigue las reglas de inferencia de tipos que presenta Pierce.
Se decidió extenderlo con el inclusión del cuantificador existencial, y de \texttt{as}.
La decisión de añadir al $\exists$ en la semántica del lenguaje, se debe a la tarea de mapear la introducción y eliminación
del existencial con un lambda término o regla de inferencia de tipo, lo cual surge de manera directa con la inclusión
del cuantificador al lenguaje. 

Sabemos que es posible describir el existencial de la siguiente manera:
